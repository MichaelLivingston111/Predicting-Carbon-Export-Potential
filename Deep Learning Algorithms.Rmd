...
ESNP.final.model <- lm(TEP ~ Log_Chl + Temperature + Phosphate + DO_Prod, 
...
CoefficientPlot <- function(models, alpha = 0.1, 
  ...
  OutputPlot <- qplot(IV, Estimate, 
                      ...
                      ylab = NULL, xlab = NULL, 
                      group = ModelLevel, shape = ModelLevel, 
...
driver <- c("Source", "Source", "Direct Environ.", "Direct Environ.",
                "Source", "Direct Environ.", "Source", 
                "Direct Environ.", "Source", "Indirect Environ.", # nuts
                "Direct Environ.", "Source", "Indirect Environ.",
                "Indirect Environ.", "Indirect Environ.", "Direct Environ.", "Direct Environ.",
                "Indirect Environ.", "Indirect Environ.")  #  driver categories

# order: Log_Chl, Temperature, Phosphate, DO_Prod, Log_Chl, Temperature, DO_Prod, MLD, Nitrate, POC, WS, SRD,
