...
# Another view
global_data %$% scatter3D(Log_Chl, Temperature, TEP, pch = 18, cex = 1, colvar=FALSE, col="red", theta = 25, phi = 20, bty="u",
                    col.panel ="azure2", expand =0.5, col.grid = "snow",
                    xlab = "Chlorophyll a (log-scale)", ylab = "Temperature (˚C)", zlab = "TEP",  
                    surf = list(x = x.pred, y = y.pred, z = z.pred,  
                    facets = TRUE, col=ramp.col (col = c("yellow","darkorange"), n = 100, alpha=0.7), fit = fitpoints,  
                    border="black"))


# And another view:
global_data %$% scatter3D(Log_Chl, Temperature, TEP, pch = 19, cex = 0.5, colvar=FALSE, 
                  col="black", theta = 35, phi = 0, bty="b2",
                  expand =0.7, 
                  xlab = "Chlorophyll a (log-scale)", ylab = "Temperature (˚C)", zlab = "TEP",
                  surf = list(x = x.pred, y = y.pred, z = z.pred,  
                      facets = NA, col ="red", fit = fitpoints ))
